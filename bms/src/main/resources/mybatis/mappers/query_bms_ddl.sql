...
CREATE TABLE T_SHOPPING_BOARD(
    ...
    CONSTRAINT BOARD_PK_BOARD_NUM PRIMARY KEY (BOARD_ID)
);
 ...
 CREATE TABLE T_SHOPPING_NOTICE(
    ...
    CONSTRAINT NOTICE_PK_NOTICE_NUM PRIMARY KEY (NOTICE_ID)
);